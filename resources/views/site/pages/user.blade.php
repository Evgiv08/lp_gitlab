...
@section('content')
<dev class="user-account-block">
    <div class="user-account-block-wrapper container">
        <h1>
            мой профиль
        </h1>
                        ...
                        <div class="social-link-block">
                            <a href="/" class="active">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                    <path d="M460.8 0H51.2C23 0 0 23 0 51.2v409.6C0 489 23 512 51.2 512h409.6c28.2 0 51.2-23 51.2-51.2V51.2C512 23 489 0 460.8 0zm-25.6 51.2V128H384c-15.4 0-25.6 10.2-25.6 25.6v51.2h76.8v76.8h-76.8v179.2h-76.8V281.6h-51.2v-76.8h51.2v-64c0-48.6 41-89.6 89.6-89.6h64z"></path>
                                </svg>
                            </a>
                            <a href="/">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                    <path d="M460.8 0H51.2C23 0 0 23 0 51.2v409.6C0 489 23 512 51.2 512h409.6c28.2 0 51.2-23 51.2-51.2V51.2C512 23 489 0 460.8 0zm-58.9 186.9c-2.6 117.8-76.8 199.7-189.4 204.8-46.1 2.6-79.4-12.8-110.1-30.7 33.3 5.1 76.8-7.7 99.8-28.2-33.3-2.6-53.8-20.5-64-48.6 10.2 2.6 20.5 0 28.2 0-30.7-10.2-51.2-28.2-53.8-69.1 7.7 5.1 17.9 7.7 28.2 7.7-23-12.8-38.4-61.4-20.5-92.2 33.3 35.8 74.2 66.6 140.8 71.7-17.9-71.7 79.4-110.1 117.8-61.4 17.9-2.6 30.7-10.2 43.5-15.4-5.1 17.9-15.4 28.2-28.2 38.4 12.8-2.6 25.6-5.1 35.8-10.2-2.5 12.7-15.3 22.9-28.1 33.2z"></path>
                                </svg>
                            </a>
                        </div>
                    </div>
        ...
        <div class="user-account-main-block">
